...
export function About() {
  ...
  return (
    <div
      className="mt-16 w-full mb-16 flex items-center justify-between relative max-sm:mt-8 max-sm:px-6 max-lg:flex-col gap-16"
      id="about"
    >
      <motion.div
        ref={ref}
      ...
      >
        ...
        <p className={`${theme == false ? "text-slate-400" : "text-zinc-800"}`}>
          ...
          controle de versão com Git/GitHub/GitLab e ferramentas de design como
          Figma, Photoshop e Adobe XD. Tenho conhecimento em gerenciamento de
          estado global usando Redux e Context API, e também estou familiarizado
          com bibliotecas de componentes UI, como Tailwind CSS, Styled
          Components, Sass, Less e CSS em geral. Sou dedicado, criativo e estou
          sempre em busca de aprimorar minhas habilidades para fornecer as
          melhores soluções front-end. Estou entusiasmado em contribuir com
          projetos desafiadores e colaborar com equipes talentosas. Se você está
          procurando um desenvolvedor front-end apaixonado por criar interfaces
          excepcionais, estou disponível para oportunidades emocionantes.
        </p>
